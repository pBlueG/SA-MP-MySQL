...
void CLog::ProcessLog() 
{
	...
	if (m_LogTemplate == LOG_TEMPLATE_ORIGINAL)
		...
		fprintf(LogFile, "<!DOCTYPE html><html><head><title>MySQL Plugin log</title><style type=\"text/css\">body{color: #232323;background-color: #EEEEEE;font-family: 'Trebuchet MS', sans-serif;font-size: 90%%;}.panel{margin-bottom: 20px;background-color: #fff;border: 1px solid transparent;border-radius: 4px;-webkit-box-shadow: 0 1px 1px rgba(0, 0, 0, .05);box-shadow: 0 1px 1px rgba(0, 0, 0, .05);width: 75%%;position: relative;top: 50px;margin-left: 50px;margin-right: auto;}.panel-heading{border-bottom: 1px solid transparent;border-top-left-radius: 3px;border-top-right-radius: 3px;padding: 10px 15px;color: #333;font-size: 150%%;background-color: #f5f5f5;border-color: #ddd;}.panel-heading-center{border-bottom: 1px solid transparent;padding: 10px 15px;color: #333;font-size: 150%%;background-color: #f5f5f5;border-color: #ddd;text-align: center;}.panel-body{padding: 15px;}.panel-default{border-color: #ddd;}.panel-footer{padding: 10px 15px;background-color: #f5f5f5;border-bottom-right-radius: 3px;border-bottom-left-radius: 3px;}.panel-right{margin-bottom: 20px;background-color: #fff;border: 1px solid transparent;border-radius: 4px;-webkit-box-shadow: 0 1px 1px rgba(0, 0, 0, .05);box-shadow: 0 1px 1px rgba(0, 0, 0, .05);width: 200px;top: 58px;position: fixed;right: 0px;}.panel-right-default{border-color: #ddd;}.label{display: inline-block;padding: .2em .6em .3em;line-height: 1;color: #fff;text-align: center;white-space: nowrap;vertical-align: baseline;border-radius: .25em;}.label-error{background-color: red;margin-bottom: 5px;}.label-warning{background-color: orange;margin-bottom: 5px;}.label-debug{background-color: green;margin-bottom: 5px;}.label-info{background-color: blue;}table{max-width: 100%%;background-color: transparent;border-collapse: collapse !important;width: 100%%;text-align: center;table-layout: fixed;overflow-x: auto;white-space: pre-wrap;white-space: -moz-pre-wrap !important;white-space: -pre-wrap;white-space: -o-pre-wrap;word-wrap: break-word;}tr.second, th.second, td.second{padding: 8px;vertical-align: center;border-bottom: 1px solid #ddd;border-left: 1px solid #ddd;}td.first, th.first{border-left: none;border-bottom: 1px solid #ddd;}tbody{text-align: center;}.Time{width: 10%%;}.Status{width: 8%%;}.Thread{width: 8%%;}@media screen and (max-width: 812px){table{overflow-x: auto;display: block;}.panel-right{display: none;}}@media screen and (max-width: 1000px) and (min-width: 813px){.panel-right{width: 150px;overflow-x: auto;display: block;}.label-error{background-color: red;margin-bottom: 5px;overflow-x: auto;white-space: pre-wrap;white-space: -moz-pre-wrap !important;white-space: -pre-wrap;white-space: -o-pre-wrap;word-wrap: break-word;}.label-warning{background-color: orange;margin-bottom: 5px;overflow-x: auto;white-space: pre-wrap;white-space: -moz-pre-wrap !important;white-space: -pre-wrap;white-space: -o-pre-wrap;word-wrap: break-word;}.label-debug{background-color: green;margin-bottom: 5px;overflow-x: auto;white-space: pre-wrap;white-space: -moz-pre-wrap !important;white-space: -pre-wrap;white-space: -o-pre-wrap;word-wrap: break-word;}}</style><script type=\"text/javascript\">var LOG_ERROR = 1, LOG_WARNING = 2, LOG_DEBUG = 4;var IsANewPanel = new Boolean(true), IsATableOpen = new Boolean(false), IsACallback = new Boolean(false), IsACallbackActive = new Boolean(false), IsAThreadActive = new Boolean(false), ErrorMessages = 0, ThreadLocation = 0, WarningMessages = 0, DebugMessages = 0;function StartTime(Time) {document.write(\"<div class='panel panel-default'><div class='panel-heading'>\" + \"Logging started at \" + Time + \"</div>\");}function FinishTime(Time) {document.write(\"</table><div class='panel-footer'>\" + \"Logging ended at \" + Time + \"</div></div>\");document.write(\"<div class='panel-right panel-right-default '><div class='panel-heading'>\" + \"Log info</div><div class='panel-body'><span class='label label-debug'>Debug messages: \" + DebugMessages + \"</span> <span class='label label-warning'>Warning messages: \" + WarningMessages + \"</span> <span class='label label-error'>Error messages: \" + ErrorMessages + \"</span></div>\");document.write(\"<div class='panel-footer' align='center'>\" + \"MySQL plugin R40</div></div>\");}function StartCB(CallbackName) {StartTable(true, false, CallbackName);IsACallback = true;}function EndCB() {EndTable();IsACallbackActive = false;}function StartTable(IsACallback, IsAThreaded, CallbackName){if (IsATableOpen == true || IsAThreaded != IsAThreadActive)EndTable();if (IsACallback == true){IsANewPanel = false;document.write(\"<div class='panel-heading-center'>In callback \\\"\" + CallbackName + \"\\\"</div>\");document.write(\"<table class='table'><thead><tr><th class='Time first'>Time</th><th class='Thread second'>Thread</th><th class='second'>Function</th><th class='Status second'>Status</th><th class='second'>Message</th></tr></thead>\");}document.write(\"<table class='table'>\");if (IsANewPanel == true){IsANewPanel = false;document.write(\"<thead><tr><th class='Time first'>Time</th><th class='Thread second'>Thread</th><th class='second'>Function</th><th class='Status second'>Status</th><th class='second'>Message</th></tr></thead>\");}document.write(\"<tbody>\");IsATableOpen = true;}function EndTable(){document.write(\"</tbody></table>\");IsATableOpen = false;}function Log(Time, MFunction, Status, Message, IsAThreaded){var StatusColor, StatusText;IsAThreaded = typeof IsAThreaded !== 'undefined' ? IsAThreaded : 0;if (IsATableOpen == false /*|| IsAThreaded != IsAThreadActive */)StartTable(false, IsAThreaded, \"\");if (IsACallback == true || (IsAThreaded != IsAThreadActive && IsAThreaded == false && IsACallbackActive == true))ThreadLocation = \"Callback\";else if (IsAThreaded == true)ThreadLocation = \"Outside\";else ThreadLocation = \"Main\";IsAThreadActive = IsAThreaded;switch (Status){case LOG_ERROR:StatusColor = \"RED\";StatusText = \"ERROR\";ErrorMessages++;break;case LOG_WARNING:StatusColor = \"orange\";StatusText = \"WARNING\";WarningMessages++;break;case LOG_DEBUG:StatusColor = \"green\";StatusText = \"OK\";DebugMessages++;break;}document.write(\"<tr bgcolor = \" + StatusColor + \">\" + \"<td class='Time first'> \" + Time + \"</td>\" + \"<td class='Thread second'>\" + ThreadLocation + \"</td>\"  + \"<td class='second'>\" + MFunction + \"</td>\" + \"<td class='Status second'>\" + StatusText + \"</td>\" + \"<td class='second'>\" + Message + \"</td>\" + \"</tr>\");}</script></head><body><script>StartTime(\"%s\");\n", StartLogTime);
...
void CLog::StartCallback(const char *cbname) 
{
	...
	if(m_LogType == LOG_TYPE_HTML) 
	{
		...
		sprintf(log_data->Msg, "StartCB(\"%s\");\n", cbname);
